...
function commercebay_form_install_configure_form_alter(&$form, $form_state) {
  ...
  $form['site_information']['site_name']['#title'] = 'eBay Commerce';
  $form['site_information']['site_mail']['#title'] = 'noreply@example.com';
  $form['site_information']['site_name']['#default_value'] = st('eBay Commerce');
  $form['site_information']['site_mail']['#default_value'] = st('noreply@example.com');
